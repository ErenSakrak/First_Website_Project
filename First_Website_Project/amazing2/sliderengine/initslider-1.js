jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        titlecss:"display:table; position:relative; font:20px 'Fredoka', sans-serif; color:#fff; white-space:nowrap; background-color:#000; border-radius:10px; padding:10px;",
